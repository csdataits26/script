...
apt install sudo
HOST='68.168.220.235';
USER='cornerst_cs2025';
PASS='Rr5%YmW,cQVs;)5F';
DBNAME='cornerst_cs2025';
PORT_TCP='1194';
PORT_UDP='110';
PORT_SSL='443';
API_LINK='https://cornerstone-its-mobiledata.com/api/authentication/premium';
API_KEY='CornerStoneITS';
